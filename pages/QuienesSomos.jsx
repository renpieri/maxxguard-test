import '../public/css/QuienesSomos.css'
...
function QuienesSomos(){
    ...
    return(
        <section className='section-quienesomos relative' id='quienesomosId'>
            <h2 className='product-title'>Seguridad de alto calibre</h2>         
                    ...
                    <div className="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1 img-text-div">
                        <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex quienes-somos-principal-text-container">
                            <div className="quienes-somos-principal-text w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                                <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center dd">Somos una empresa joven, innovadora y dinámica, con un marcado espíritu emprendedor.
                        Nos especializamos en el diseño, producción y comercialización de Armeros de Seguridad, cumpliendo estrictamente con las normativas vigentes establecidas por la ANMaC.</p>
                        ...
                        <img className="lg:mx-0 mx-auto h-full rounded-3xl object-cover img-quienes-somos" src="/public/img/IMG_2683.jpg" alt="about Us image" />
                    </div>
                </div>
