...
function Contacto() {
  ...
  return (
    <section className='section-contacto relative z-10 overflow-hidden bg-white dark:bg-dark' id='contactoId'>
            ...
            <div className="w-full px-4">
              <div className="mb-12 lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                  Ponete en contacto con nosotros y descubrí cómo podemos brindarte la mejor solución.
                  En MAXXGUARD contamos con un equipo preparado para responder todas tus consultas.
                  La seguridad y confianza son nuestra prioridad..
                </p>
            </div>
                <div className="flex contacto-info-flex">
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    <a href="https://wa.me/541124903366" target="_blank" rel="noopener noreferrer" className='flex m-auto w-full'>
                      ...
                      <h4 className="mb-1 text-xl font-bold text-dark dark:text-white  icon-info-title">
                        Whatsapp
                      </h4>
                      <p className="text-base text-body-color dark:text-dark-6  icon-info-text">
                        11 2490 3366
                      </p>
                    </div>
                    </a>
